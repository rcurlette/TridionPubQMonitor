...
using TridionPubQMonitoringService.Utils;

// Code From:
// https://github.com/chrismrgn/Tridion.Templates.CoreService/tree/master/Tridion.Templates.CoreService.Core 

namespace TridionPubQMonitoringService.CoreService
{
